...
```python
!pip install tensorflowjs > /dev/null 2>&1 #Это нужно выполнить только один раз для установки зависимостей. В дальнейшем, после установки, эту строку можно закомментировать для уэкономии времени
import tensorflowjs
